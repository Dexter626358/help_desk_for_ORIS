"""Общие проверки входных данных: файлы, URL, email (не XSD / не JATS)."""
...
class Validator:
    ...
    def validate_url(self, url: str) -> bool:
        """Валидация URL для исходящих запросов (с SSRF-защитой)."""
        from ipsas.common.ssrf import is_safe_fetch_url

        return is_safe_fetch_url(url)
