...
FIELD_TO_CATEGORY: Dict[str, str] = {
    ...
    "orcid": "authors_orgs",
    "email": "authors_orgs",
    "corresponding_author": "authors_orgs",
...
RULES: List[RuleInfo] = [
    ...
    {"id": "ISSUE_SERIAL", "category": "issue", "title": "Дополнительный номер в скобках", "field": "issue_serial"},
    ...
    {"id": "AU_CORRESPONDING", "category": "authors_orgs", "title": "Автор для переписки", "field": "corresponding_author"},
